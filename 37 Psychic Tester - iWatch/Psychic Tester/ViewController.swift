...
class ViewController: UIViewController, WCSessionDelegate {
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    // in viewDidAppear and NOT viewDidLoad because it is an alert
  ...
  override func viewDidLoad() {
    ...
    UIView.animate(withDuration: 20, delay: 0, options: [.allowUserInteraction, .autoreverse, .repeat], animations: { self.view.backgroundColor = UIColor.blue })
  }
